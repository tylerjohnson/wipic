...
public class SocketRequestGet implements Runnable{

    private final String MACHINE_NAME = "localhost";
    private final int PORT_NUMBER = 8087;

    private String id, username, serverResponse;

    public SocketRequestGet(String id, String username) {
        this.id = id;
    ...
    public void run(){
        ...
        if (myClient != null && os != null && is != null) {
            try {
                os.writeBytes("respond" + "&" +username + "&" + id + "\n");
